...
function getStageEmoji(plot) {
  const stages = safeJson(plot.plant_stages, ["\uD83C\uDF31"]);
  if (plot.state === "ready")
    return stages[stages.length - 1] || "\uD83C\uDF3B";
  return stages[plot.stage - 1] || stages[0] || "\uD83C\uDF31";
}
function getItemEmoji(item) {
  if (item.type === "seed")
    return "\uD83C\uDF31";
  const stages = safeJson(item.stages, ["\uD83D\uDCE6"]);
  if (item.type === "harvest")
    return stages[stages.length - 1] || "\uD83C\uDF81";
  return "\uD83D\uDCE6";
}
async function loadAll() {
  const [balanceRes, plotsRes, shopRes, invRes, marketRes] = await Promise.all([
...
async function buyPlant(plantId, currency) {
  const res = await api("POST", "/garden/buy", { plant_id: plantId, currency, quantity: 1 });
  if (res.ok) {
...
function Plot({ plot }) {
  const handleClick = () => {
    ...
    } else if (plot.state === "ready" || isPlotReady(plot)) {
      onHarvest(plot.idx);
    }
  };
  const classes = ["plot", plot.state];
  if (plot.rarity)
...
function showSeedPicker(plotIdx) {
  ...
  if (!seeds.length) {
    showModal(/* @__PURE__ */ u4("div", {
      children: [
        ...
        /* @__PURE__ */ u4("p", {
          style: { margin: "12px 0", color: "var(--text-dim)", fontSize: 13 },
  ...
  showModal(/* @__PURE__ */ u4("div", {
    children: [
      ...
      seeds.map((s4) => /* @__PURE__ */ u4("div", {
        style: { display: "flex", alignItems: "center", gap: 8, padding: "6px 0", borderBottom: "1px solid var(--border)" },
        children: [
          /* @__PURE__ */ u4("span", {
            children: s4.plant_name || "Растение"
          }, undefined, false, undefined, this),
          s4.rarity ? /* @__PURE__ */ u4("span", {
            className: `rarity-badge ${s4.rarity}`,
            children: s4.rarity
          }, undefined, false, undefined, this) : null,
          /* @__PURE__ */ u4("span", {
            style: { flex: 1, textAlign: "right", color: "var(--text-dim)" },
            children: [
              "×",
              s4.quantity
            ]
...
function safeJson2(str, fallback) {
  if (!str)
    return fallback;
  try {
    return JSON.parse(str);
...
function Shop() {
  const activeCurrency = useSignal("bipki");
  ...
  return /* @__PURE__ */ u4("div", {
    children: [
      /* @__PURE__ */ u4("div", {
        ...
        children: [
          /* @__PURE__ */ u4("button", {
            className: `tab ${activeCurrency.value === "bipki" ? "active" : ""}`,
            onClick: () => {
              activeCurrency.value = "bipki";
            },
            children: "\uD83E\uDE99 За бипки"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ u4("button", {
            className: `tab ${activeCurrency.value === "megabipki" ? "active" : ""}`,
            onClick: () => {
              activeCurrency.value = "megabipki";
            },
            children: "\uD83D\uDC8E За мегабипки"
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      /* @__PURE__ */ u4("div", {
        ...
        children: items.map((plant) => {
          const useMegabipki = activeCurrency.value === "megabipki";
          const price = useMegabipki ? plant.megabipki_price : plant.seed_price;
          const canAfford = useMegabipki ? userBalance.value.megabipki >= price : userBalance.value.bipki >= price;
          const stages = safeJson2(plant.stages, ["\uD83C\uDF31"]);
          return /* @__PURE__ */ u4("div", {
            className: "shop-card",
            children: [
              /* @__PURE__ */ u4("div", {
                className: "icon",
                children: stages[stages.length - 1] || "\uD83C\uDF31"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ u4("div", {
                className: "info",
                children: [
                  /* @__PURE__ */ u4("div", {
                    ...
                    children: [
                      ...
                      " ",
                      /* @__PURE__ */ u4("span", {
                        className: `rarity-badge ${plant.rarity}`,
                        children: plant.rarity
                      }, undefined, false, undefined, this)
                    ]
                  }, undefined, true, undefined, this),
              ...
              /* @__PURE__ */ u4("div", {
                children: [
                  ...
                  /* @__PURE__ */ u4("button", {
                    className: `btn ${canAfford ? "btn-primary" : ""} ${!canAfford ? "disabled" : ""}`,
                    disabled: !canAfford,
                    onClick: () => buyPlant(plant.id, activeCurrency.value),
                    children: "Купить"
                  }, undefined, false, undefined, this)
                ]
              }, undefined, true, undefined, this)
...
function Inventory() {
  ...
  const filtered = filter.value === "all" ? items : items.filter((i4) => i4.type === filter.value);
  return /* @__PURE__ */ u4("div", {
    children: [
      /* @__PURE__ */ u4("div", {
        ...
        children: [
          /* @__PURE__ */ u4("button", {
            className: `tab ${filter.value === "all" ? "active" : ""}`,
            onClick: () => {
              filter.value = "all";
            },
            children: "Всё"
          ...
          /* @__PURE__ */ u4("button", {
            className: `tab ${filter.value === "seed" ? "active" : ""}`,
            onClick: () => {
              filter.value = "seed";
            },
            children: "\uD83C\uDF31 Семена"
          ...
          /* @__PURE__ */ u4("button", {
            className: `tab ${filter.value === "harvest" ? "active" : ""}`,
            onClick: () => {
...
function InventoryCard({ item }) {
  ...
  const typeLabel = item.type === "seed" ? "семян" : item.type === "harvest" ? "шт" : "";
  return /* @__PURE__ */ u4("div", {
    className: "inv-card",
    children: [
      /* @__PURE__ */ u4("div", {
      ...
      /* @__PURE__ */ u4("div", {
        className: "name",
        children: item.plant_name || "Предмет"
      }, undefined, false, undefined, this),
      /* @__PURE__ */ u4("div", {
        className: "qty",
        children: [
      ...
      /* @__PURE__ */ u4("div", {
        className: "actions",
        children: [
          item.type === "harvest" && item.tradeable ? /* @__PURE__ */ u4("button", {
            className: "btn btn-gold btn-sm",
            onClick: () => showSellModal(item.id),
            children: "\uD83D\uDCB0 Продать"
          }, undefined, false, undefined, this) : null,
          item.type === "harvest" ? /* @__PURE__ */ u4("button", {
  ...
  showModal(/* @__PURE__ */ u4("div", {
    children: [
      ...
      /* @__PURE__ */ u4("input", {
        ...
        min: 1,
        value: price,
        style: { width: "100%", padding: 8, borderRadius: 8, border: "1px solid var(--border)", background: "var(--surface2)", color: "var(--text)", fontSize: 16, margin: "8px 0" },
        onInput: (e4) => {
          price = parseInt(e4.target.value, 10) || 0;
        }
      }, undefined, false, undefined, this),
      /* @__PURE__ */ u4("button", {
        className: "btn btn-gold",
        onClick: () => sellItem(itemId, price),
        children: "Выставить"
      }, undefined, false, undefined, this)
    ]
  }, undefined, true, undefined, this));
...
function Market() {
  ...
  return /* @__PURE__ */ u4("div", {
    ...
    children: items.map((trade) => /* @__PURE__ */ u4("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ u4("div", {
          className: "price",
          children: [
            trade.currency === "megabipki" ? "\uD83D\uDC8E" : "\uD83E\uDE99",
            " ",
            trade.price
          ]
        }, undefined, true, undefined, this),
        trade.is_own ? /* @__PURE__ */ u4("button", {
          className: "btn btn-sm",
...
function TabBar() {
  return /* @__PURE__ */ u4("div", {
    ...
    children: TABS.map((tab) => /* @__PURE__ */ u4("button", {
      className: `tab ${activeView.value === tab.id ? "active" : ""}`,
      onClick: () => {
  ...
  return /* @__PURE__ */ u4("div", {
    ...
    children: [
      /* @__PURE__ */ u4("header", {
        id: "header",
        children: [
          /* @__PURE__ */ u4(TabBar, {}, undefined, false, undefined, this),
          /* @__PURE__ */ u4(BalanceBar, {}, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      /* @__PURE__ */ u4("main", {
        id: "content",
